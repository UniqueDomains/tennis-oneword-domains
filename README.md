...
> **Important:** this repository is a **public 9,723-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,065 domains** on the canonical page below.

**Public extract:** 9,723 rows · **Live catalog:** 5,622,065 domains
...
| ----------------------- | ------------------------------------------------ |
| 9,723-row public sample | 5,622,065 live domains                           |
...
> Unique Domains. *Available .TENNIS One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
