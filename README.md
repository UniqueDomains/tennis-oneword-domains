# Available .TENNIS One-Word Domains (5,622,065)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C722%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C622%2C065%20domains-6f42c1">
...
> **Important:** this repository is a **public 9,722-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,065 domains** on the canonical page below.

**Public extract:** 9,722 rows · **Live catalog:** 5,622,065 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/tennis?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_tennis_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/tennis?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_tennis_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./tennis.csv">CSV</a> / <a href="./tennis.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_tennis_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_tennis_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .TENNIS search](https://unique.domains/domains/tld/tennis?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_tennis_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .TENNIS search](https://unique.domains/domains/tld/tennis?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_tennis_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./tennis.csv) or [Download JSON](./tennis.json)
...
| ----------------------- | ------------------------------------------------ |
| 9,722-row public sample | 5,622,065 live domains                           |
...
| --------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ------------------------------------------- |
| business.tennis | available | $81.98    | —             | 100            | 54     | 8      | namecheap                                   |
...
| one.tennis      | resell    | —         | —             | 132            | 51     | 3      | Automattic Inc.                             |
| all.tennis      | premium   | $250      | $250          | 88             | 48     | 3      | name.com                                    |
| clear.tennis    | available | $80.99    | $86.99        | 90             | 50     | 5      | name.com                                    |
...
| star.tennis     | resell    | —         | —             | 86             | 45     | 4      | GoDaddy.com, LLC                            |
| learning.tennis | premium   | $128.70   | $128.70       | 76             | 41     | 8      | namecheap                                   |
...
> Unique Domains. *Available .TENNIS One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
